...
#################################
filePath = '/Users/user/Dropbox/T@CW/TERM 2/wkshps/python/ScrabbleWordList.txt'
...
fontPath = '/Users/user/Documents/RoboFonts/tcw2/tbd3/tbd3.12.otf'
fontName = installFont(fontPath)

lettersUC = ''
lettersLC = 'hamburgfontid'
### Helper functions ############
